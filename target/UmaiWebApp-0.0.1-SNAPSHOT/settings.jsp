          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Product Settings</h3>
                </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="foodsettings.jsp"><i class="fas fa-arrow-right text-success mr-3"></i></a> 
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="drinksettings.jsp"><i class="fas fa-arrow-right text-success mr-3"></i></a> 
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="dessersettings.jsp"><i class="fas fa-arrow-right text-success mr-3"></i></a> 
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="dealsettings.jsp"><i class="fas fa-arrow-right text-success mr-3"></i></a> 
                    </td>
                  </tr>
               ...
               <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="#"><i class="fas fa-arrow-right text-success mr-3"></i></a> 
                    </td>
                  </tr>
